...
Actions.prototype = {
  ...
  mail: function(email, subject, templatePath, data) {
    ...
    var approveButton = `<a href="${data.webhookAddress}/?id=${data.id}&email=${email}&applicantEmail=${data.applicantEmail}&application=${urlencode(data.application)}&apiKey=${receiver.apiKey}&approved=true"><button>Approve</button></a>`
    var rejectButton =  `<a href="${data.webhookAddress}/?id=${data.id}&email=${email}&applicantEmail=${data.applicantEmail}&application=${urlencode(data.application)}&apiKey=${receiver.apiKey}&approved=false"><button>Reject</button></a>`
