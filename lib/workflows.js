...
Workflows.createInstance = function(actions, params = {}) {
  if (members[params.approverId]) {
    return new Workflows(actions, params);
  } else {
    console.log(`Please make sure the ${params.approverId} approverId is listed in the members.json.`);
    return null;
  }
};
